<nav x-data="{ open: false }" class="bg-gray-600 border-b border-orange-500">
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-800 bg-orange-500 hover:text-white hover:bg-gray-800 hover:border-orange-500 focus:outline-none transition ease-in-out duration-150">
                            <div class="ms-1">
                    ...
                    <x-slot name="content">
                        ...
                        @if(Auth::check() && \App\Actions\IsUserAdmin::handle(true))
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('updateAppliance')" :active="request()->routeIs('updateAppliance')">
                {{ __('Update Appliance') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('addAppliance')" :active="request()->routeIs('addAppliance')">
                {{ __('Add Appliance') }}
            </x-responsive-nav-link>
